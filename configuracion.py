...
class Configuracion:
    ...
    def __init__(self):
        ''' Inicializa la clase Configuracion.'''
        ...
        def create_folder_input(texto):
            ...
            return sg.Column([
                ...
                [sg.Text('', size=(1, 10), background_color='white')]
            ], size=(450, 90), background_color='white')

        relative_path = "C:\\Users\\marti\\Desktop\\proyecto\\ventanas\\botones\\botonVolver2.png"
        relative_path2 = "C:\\Users\\marti\\Desktop\\proyecto\\ventanas\\botones\\salvar.png"
        ...
        boton_guardar = [sg.Button(image_filename=boton_guardar, image_size=(50, 50), button_color='white',
        ...
        col2 = sg.Column([[columna_vacia]] + [[col] for col in columnas], size=(450, 600), justification='center',
                         vertical_alignment='center', background_color='white')
        col3 = sg.Column(elem_col3, size=(100, 600), background_color='white')

        layout1 = [[col1, sg.Push(background_color='white'), col2, col3]]

        self.window = sg.Window('UNLPImage', background_color='white', element_padding=(0, 3), size=(800, 600),
                                layout=layout1)

    def abrir_configuracion(self, perfil_act):
        '''Abre la ventana de configuración y maneja los eventos.
        ...
        while True:
            ...
            if event == sg.WIN_CLOSED:
                ...
                with open("C:\\Users\\marti\\Desktop\\proyecto\\ventanas\\datos\\data.json", "w", encoding='utf-8') as archivo:
                    json.dump(datos, archivo)
                with open('logs.csv','w',encoding='utf-8') as logs:
                    s = csv.writer(logs)
                    s.writerow([perfil_act,datetime.datetime.now(),' Cambio en la configuración del sistema'])
            elif event == 'VOLVER':
                self.window.close()
