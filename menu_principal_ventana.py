...
"""
Clase que define el mmenu principal de la aplicación y sus funcionalidades.

Args:
    - perfil_act (str): Nombre del perfil que se desea mostrar en la ventana.
"""
class VentanaMenu:
    ...
    def __init__(self, perfil_act):
        ...
        relative_path = "C:\\Users\\marti\\Desktop\\proyecto\\ventanas\\botones\\config.png"
        relative_path_2 = "C:\\Users\\marti\\Desktop\\proyecto\\ventanas\\botones\\help.png"
        ...
        with open('C:\\Users\\marti\\Desktop\\proyecto\\ventanas\\datos\\perfil.json', 'r', encoding='utf-8') as archivo: 
        ...
        while True:
            ...
            if event == sg.WIN_CLOSED:
                ...
                try:
                    ...
                    sg.Popup('''No esta cargado un directorio''', 
                 title='Error')
                    inicio = inicio_ventana.VentanaPrincipal()
                    inicio.iniciar_ventana()
            elif event == 'help':
                sg.Popup('''Esta ventana proporciona una navegación fluida entre las diferentes funcionalidades de la aplicación.\n
                En la parte superior de la ventana, se mostrará el perfil seleccionado, incluyendo su avatar y nombre. \n
                Al hacer clic en la imagen del perfil, se desplegará la ventana para editar el perfil (D - Editar perfil). \n
